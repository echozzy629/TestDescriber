/**
 * HexadecimalDocument.java A class that limits input into a text area to
 * Hexadecimal values.
 */
...
/**
 * The <code>HexadecimalDocument</code> class controls the character input
 * into text areas.
 * <P>
 * 
 ...
 * examined to contain only Hexadecimal values. If it passes this test then the
