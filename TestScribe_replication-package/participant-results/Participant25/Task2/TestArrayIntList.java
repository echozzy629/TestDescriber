...
public class TestArrayIntList {
	...
	public void test3() throws Throwable {
		...
		try {
			// the method add 42 to the object "arrayIntList0"
			arrayIntList0.add(42);
		} catch (ArithmeticException e) {
			fail("Expecting exception: ArithmeticException");
		}
	}
	...
	public void test5() throws Throwable {
		...
		try {
			// It sets the element -666 at index -432 in arrayIntList0
			arrayIntList0.set((-432), (-666));
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
	         //
	         // Should be at least 0 and less than 0, found -432
	         //
		}
	}
	...
	public void test6() throws Throwable {
		...
		ArrayIntList arrayIntList0 = new ArrayIntList();
		try {
			// The next method call add the element to -2223 "arrayIntList0" at 
			// index -546
			arrayIntList0.add((-546), (-2223));
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
			//
	...
	public void test8() throws Throwable {
		...
		arrayIntList0.ensureCapacity(8894);
		assertEquals(8, arrayIntList0.size());
	}
	...
	public void test9() throws Throwable {
		...
		ArrayIntList arrayIntList0 = new ArrayIntList();
		try {
			// The next method call removes the element at index 2 of
			// "arrayIntList0"
			arrayIntList0.removeElementAt(2);
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
	         //
	...
	public void test10() throws Throwable {
		...
		ArrayIntList arrayIntList0 = new ArrayIntList();
		try {
			// It retrieves the element at index 13 of arrayIntList0
			arrayIntList0.get(13);
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
	         //
	         // Should be at least 0 and less than 0, found 13
	         //
		}
	}
	...
	public void test12() throws Throwable {
		...
		ArrayIntList arrayIntList0 = new ArrayIntList();
		try {
			// The next method call add the element 4499 to "arrayIntList0" at 
			// index 4499
			arrayIntList0.add(4499, 4499);
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
	         //
	         // Should be at least 0 and at most 0, found 4499
	         //
		}
	}
