...
public class TestArrayIntList {
	 ...
	 **/
	@Ignore //FIXME this test case does not make sense to me
	@Test
	...
	/**
	 * OVERVIEW: The test case "test3" covers around 3.0% (low percentage) of
	 * statements in "ArrayIntList"
	 **/
	@Test
	@Ignore // wrong assumption due to bug in code
	 ...
	 * statements in "ArrayIntList"
	 **/
	@Ignore // doesn't make sense. the constructor fails due to the bug in the add-method
	...
	public void test6() throws Throwable {
		...
		ArrayIntList arrayIntList0 = new ArrayIntList();
		try {
			// The next method call add the element to -1 "arrayIntList0" at 
			// index -1
	...
	public void test7() throws Throwable {
		...
		ArrayIntList arrayIntList0 = new ArrayIntList();
		try {
			// It sets the element 465 at index 1 in arrayIntList0
			arrayIntList0.set(1, 465);
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
			 //
	         // Should be at least 0 and less than 0, found 1
	...
	public void test11() throws Throwable {
		...
		try {
			...
			// equal to -1743.
			arrayIntList0 = new ArrayIntList((-1743));
			fail("Expecting exception: IllegalArgumentException");
		} catch (IllegalArgumentException e) {
	         //
	         // capacity -1743
	...
	/**
	 * OVERVIEW: The test case "test12" covers around 5.0% (low percentage) of
	 * statements in "ArrayIntList"
	 **/
	// FIXME why testing trimToSize and add in the same test case?
	@Test
	public void test12() throws Throwable {
		...
		arrayIntList0.trimToSize();
		try {
			// the method add 143 to the object "arrayIntList0"
			arrayIntList0.add(143);
			fail("Expecting exception: ArithmeticException");
		} catch (ArithmeticException e) {
	         //
	         // / by zero
