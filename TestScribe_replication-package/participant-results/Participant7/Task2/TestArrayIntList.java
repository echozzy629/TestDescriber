...
public class TestArrayIntList {
  ...
  public void test0()  throws Throwable  {
      ...
      arrayIntList0.ensureCapacity(6);
  ...
  public void test1()  throws Throwable  {
      ...
      assertEquals(1,arrayIntList0.get(0));// Changed
  ...
  public void test4()  throws Throwable  {
      ...
      arrayIntList0.add(562);
      assertEquals(562,arrayIntList0.get(0)); //Changed
  ...
  public void test7()  throws Throwable  {
      ArrayIntList arrayIntList0 = new ArrayIntList();
      try {
        arrayIntList0.add((-19), (-19));
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // Should be at least 0 and at most 0, found -19
         //
      }
  }
  ...
  public void test9()  throws Throwable  {
      ...
      for (int i=0; i< 1000; i++ )
    	  arrayIntList0.add(0, 1);
      for (int i=0; i<1000; i++);
      	arrayIntList0.removeElementAt(0); // Changed
      assertEquals(0,arrayIntList0.size()); //Changed
  }
  ...
  public void test12()  throws Throwable  {
      ArrayIntList arrayIntList0 = new ArrayIntList();
      try {
    	  arrayIntList0.add(651, 2545);
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // Should be at least 0 and at most 0, found 651
         //
      }
  }
 ...
 @Test
  public void test13()  throws Throwable  {
      ...
      ArrayIntList arrayIntList0 = null;
      arrayIntList0 = new ArrayIntList((IntCollection) arrayUnsignedShortList0);
      assertEquals(677,arrayIntList0.get(0)); //Changed
  ...
  public void test14()  throws Throwable  {
      ArrayIntList arrayIntList0 = null;
      try {
        arrayIntList0 = new ArrayIntList((-1543));
        fail("Expecting exception: IllegalArgumentException");
