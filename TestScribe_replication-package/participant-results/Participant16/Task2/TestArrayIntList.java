...
public class TestArrayIntList {
	 ...
	 * statements in "ArrayIntList"
	 **/
	/*@Test   Arithmetic exception make no sense
	public void test3() throws Throwable {
		...
		try {
			// the method add 3 to the object "arrayIntList0"
			arrayIntList0.add(3);
			fail("Expecting exception: ArithmeticException");
		} catch (ArithmeticException e) {
	         //
	...
	public void test4() throws Throwable {
		...
		try {
			// It sets the element -1 at index -656 in arrayIntList0
			arrayIntList0.set((-656), (-1));
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
	         //
	         // Should be at least 0 and less than 0, found -656
	         //
		}
	}
	...
	public void test5() throws Throwable {
		...
		ArrayIntList arrayIntList0 = new ArrayIntList();
		try {
			// The next method call add the element to -561 "arrayIntList0" at 
			// index -561
			arrayIntList0.add((-561), (-561));
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
			//
	        // Should be at least 0 and at most 0, found -561
	        //
		}
	}
	...
	public void test6() throws Throwable {
		...
		ArrayIntList arrayIntList0 = new ArrayIntList();
		try {
			// It sets the element 0 at index 2963 in arrayIntList0
			arrayIntList0.set(2963, 0);
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
			 //
	         // Should be at least 0 and less than 0, found 2963
	         //
		}
	}
	...
	public void test7() throws Throwable {
		...
		arrayIntList0.ensureCapacity(734);
		// Then, it tests:
		// 1) whether the size of "arrayintlist0" is equal to 0;
		assertEquals(0, arrayIntList0.size());
	}
	...
	public void test10() throws Throwable {
		...
		ArrayIntList arrayIntList0 = new ArrayIntList();
		try {
			// It retrieves the element at index 8 of arrayIntList0
			arrayIntList0.get(8);
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
	         //
	...
	public void test11() throws Throwable {
		...
		// configuration (initial capacity is 8)
		ArrayIntList arrayIntList0 = new ArrayIntList();
		// The next method call the ensure capacity in min cap 734 to
		// arrayIntList0
		// The execution of this method call implicitly covers the following 1
		// conditions:
		// - the condition " min capacity greater than _data.length" is TRUE;
	...
	public void test12() throws Throwable {
		...
		// equal to 65535
		ArrayIntList arrayIntList0 = new ArrayIntList(65535);
		try {
			// The next method call add the element 65535 to "arrayIntList0" at 
			// index 141
			arrayIntList0.add(141, 65535);
			fail("Expecting exception: IndexOutOfBoundsException");
		} catch (IndexOutOfBoundsException e) {
	         //
	         // Should be at least 0 and at most 0, found 141
	         //
		}
	}
