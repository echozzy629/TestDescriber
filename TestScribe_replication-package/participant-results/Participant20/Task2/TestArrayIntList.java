...
public class TestArrayIntList {
  ...
  @Test
  public void test9()  throws Throwable  { // redundant, similiar as test0
      ArrayIntList arrayIntList0 = new ArrayIntList();
  ...
  @Test
  public void test13()  throws Throwable  { //redundant, similar as test9 and test0
      ArrayIntList arrayIntList0 = new ArrayIntList();
  ...
  public void test15()  throws Throwable  {
      ...
      arrayIntList0 = new ArrayIntList((IntCollection) arrayUnsignedShortList0);
      assertEquals(1, arrayIntList0.size());
      assertEquals(677, arrayIntList0.get(0));
  }
  ...
  public void test17()  throws Throwable  {
      ...
      arrayIntList0.add(110);
      assertEquals(1, arrayIntList0.size()); 
      int elem = arrayIntList0.removeElementAt(0);
      assertEquals(0, arrayIntList0.size());
      assertEquals(110, elem);
  }
  ...
  public void test18()  throws Throwable  {
      ArrayIntList arrayIntList0 = new ArrayIntList();
      arrayIntList0.add(110);
      int old = arrayIntList0.set(0, 120);
      assertEquals(1, arrayIntList0.size()); 
      assertEquals(110, old);
      int elem = arrayIntList0.removeElementAt(0);
      assertEquals(0, arrayIntList0.size());
      assertEquals(120, elem);
  }
  ...
  public void test19()  throws Throwable  {
      ArrayIntList arrayIntList0 = new ArrayIntList();
      arrayIntList0.add(110);
      arrayIntList0.add(120);
      assertEquals(2, arrayIntList0.size()); 
      int elem = arrayIntList0.removeElementAt(0);
      assertEquals(1, arrayIntList0.size());
      assertEquals(110, elem);
      elem = arrayIntList0.removeElementAt(0);
      assertEquals(0, arrayIntList0.size());
      assertEquals(120, elem);
  }
}
